...
class TestSummarize(unittest.TestCase):
    ...
    def test_create_intervals(self):
        ...
        logger.debug("First entry should be %s is %s", TestSummarize.test_msgs[0:4], msgs[0][1])
        self.assertTrue(msgs[0][1] == TestSummarize.test_msgs[0:4])
        self.assertTrue(msgs[1][1] == TestSummarize.test_msgs[4:])
        asd2 = [{'minutes': 5}, ]
    ...
    def test_text_rank_summarization(self):
        ...
        asd = [{'minutes': 60, 'size' : 1}, {'hours':12, 'size' : 1}]
